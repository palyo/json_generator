                          ...
                          child: Padding(
                            ...
                            child: Stack(
                              children: [
                                Opacity(
                                    opacity: 0.02,
                                    child: Image.asset("assets/images/ic_banner_bg.png",
                                        fit: BoxFit.cover)),
                                Column(
                                        ...
                                        Expanded(
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              errorText:
                                                  _isBgImageValid ? "Enter Background Image" : null,
                                              errorStyle: TextStyle(
                                                  fontSize: 12.0,
                                                  fontFamily: 'Sans',
                                                  fontStyle: FontStyle.normal,
                                                  fontWeight: FontWeight.w300,
                                                  color: _isBgImageValid
                                                      ? Utils.getErrorColor()
                                                      : Utils.getHintColor()),
                                              ...
                                              errorBorder: OutlineInputBorder(
                                                borderSide: BorderSide(
                                                    color: Utils.getErrorColor(), width: 2.0),
                                              ...
                                              enabledBorder: OutlineInputBorder(
                                                borderSide: BorderSide(
                                                    color: Utils.getHintColor(), width: 2.0),
                                                borderRadius: BorderRadius.circular(4.0),
                                              ),
                                              ...
                                              focusedBorder: OutlineInputBorder(
                                                borderSide: BorderSide(
                                                    color: Utils.getAccentColor(), width: 2.0),
                                                borderRadius: BorderRadius.circular(4.0),
                                              ),
                                            ),
                                            onTap: () {
                                              setState(() {
                                                FocusScope.of(context)
                                                    .requestFocus(_bgImageFocusNode);
                                              });
                                            },
                                          ),
                                        ),
                                        ...
                                        Expanded(
                                          ...
                                          child: TextFormField(
                                            ...
                                            onTap: () {
                                              setState(() {
                                                FocusScope.of(context)
                                                    .requestFocus(_bgColorFocusNode);
                                              });
                                            },
                                          ),
                                        ),
                                        ...
                                        Expanded(
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              errorText:
                                                  _isPosterTypeValid ? "Enter Poster Type!" : null,
                                              errorStyle: TextStyle(
                                                  fontSize: 12.0,
                                                  fontFamily: 'Sans',
                                                  fontStyle: FontStyle.normal,
                                            ...
                                            onTap: () {
                                              setState(() {
                                                FocusScope.of(context)
                                                    .requestFocus(_posterTypeFocusNode);
                                              });
                                            },
                                          ),
                                        ),
                                        ...
                                        Expanded(
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              errorText: _isPosterWidthValid
                                                  ? "Enter valid Poster Width"
                                                  : null,
                                              errorStyle: TextStyle(
                                                  fontSize: 12.0,
                                                  fontFamily: 'Sans',
                                            ...
                                            onTap: () {
                                              setState(() {
                                                FocusScope.of(context)
                                                    .requestFocus(_posterWidthFocusNode);
                                              });
                                            },
                                          ),
                                        ),
                                        ...
                                        Expanded(
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              errorText: _isPosterHeightValid
                                                  ? "Enter valid Poster Height!"
                                                  : null,
                                              errorStyle: TextStyle(
                                                  fontSize: 12.0,
                                                  fontFamily: 'Sans',
                                            ...
                                            onTap: () {
                                              setState(() {
                                                FocusScope.of(context)
                                                    .requestFocus(_posterHeightFocusNode);
                                              });
                                            },
                                          ),
                                        ),
                                        ...
                                        child: ElevatedButton.icon(
                                          ...
                                          onPressed: () async {
                                            var template = Template(
                                              ...
                                              posterWidth:
                                                  double.parse(_posterWidthController.text),
                                              posterHeight:
                                                  double.parse(_posterHeightController.text),

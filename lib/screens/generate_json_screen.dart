    ...
    return Scaffold(
        ...
        body: SafeArea(
          ...
          child: Form(
              ...
              child: Center(
                child: SizedBox(
                    height: Responsive.isDesktop(context) ? heightSize * 0.90 : heightSize,
                    width: Responsive.isDesktop(context) ? widthSize * 0.80 : widthSize,
                    child: Center(
                      child: Padding(
                                          ...
                                          children: [
                                            Align(
                                              ...
                                              child: Text(
                                                ...
                                                style: TextStyle(
                                                    fontSize:
                                                        Responsive.isDesktop(context) ? 20.0 : 16.0,
                                                    fontFamily: 'Sans',
                                                    fontStyle: FontStyle.normal,
                                            ...
                                            Align(
                                                ...
                                                child: ElevatedButton.icon(
                                                  style: TextButton.styleFrom(
                                                    elevation: 0.0,
                                                    backgroundColor: Utils.getCardColor(),
